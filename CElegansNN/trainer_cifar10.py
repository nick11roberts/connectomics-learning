...
from dataset.dataloader import cifar10_dataloader
...
if __name__ == '__main__':
    ...
    trainset = cifar10_dataloader(hp, args, True)
    valset = cifar10_dataloader(hp, args, False)
    train(out_dir, chkpt_path, trainset, valset, writer, logger, hp, hp_str, graphs, in_channels=3)
